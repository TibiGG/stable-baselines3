...
from stable_baselines3.common.vec_env import DummyVecEnv, SubprocVecEnv, MultiagentVecEnv, VecEnv
...
def make_vec_env(
    ...
    vec_env_cls: Optional[Type[Union[DummyVecEnv, SubprocVecEnv, MultiagentVecEnv]]] = None,
